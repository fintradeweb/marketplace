              ...
              <div class="card-body">
                ...
                <div class="col-xs-12 col-sm-12 col-md-12">
                  <div class="form-group">
                    ...
                    <input type="text" name="ams_how_clients" id="ams_how_clients" class="form-control" value="{{ $indiv->ams_how_clients }}" placeholder="Number clients">
              ...
              <div class="card-body">  
                <div class="col-xs-12 col-sm-12 col-md-12">
                  <div class="form-group">
                    ...
                    <input type="text" name="estimated_montly_financing" id="estimated_montly_financing" class="form-control" value="{{ $indiv->estimated_montly_financing }}" placeholder="Estimated monthly financing volume">
                ...
                <div class="col-xs-12 col-sm-12 col-md-12">
                  <div class="form-group">
                    ...
                    <input type="text" name="emf_number_clients" id="emf_number_clients" class="form-control" value="{{ $indiv->emf_number_clients }}" placeholder="Number clients">
