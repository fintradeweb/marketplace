...
unset($__errorArgs, $__bag); ?>
                ...
                <div class="col-xs-12 col-sm-12 col-md-12">
                  <div class="form-group">
                    ...
                    <input type="text" name="ams_how_clients" id="ams_how_clients" class="form-control" value="<?php echo e($indiv->ams_how_clients); ?>" placeholder="Number clients">
              ...
              <div class="card-body">  
                <div class="col-xs-12 col-sm-12 col-md-12">
                  <div class="form-group">
                    ...
                    <input type="text" name="estimated_montly_financing" id="estimated_montly_financing" class="form-control" value="<?php echo e($indiv->estimated_montly_financing); ?>" placeholder="Estimated monthly financing volume">
...
unset($__errorArgs, $__bag); ?>
                ...
                <div class="col-xs-12 col-sm-12 col-md-12">
                  <div class="form-group">
                    ...
                    <input type="text" name="emf_number_clients" id="emf_number_clients" class="form-control" value="<?php echo e($indiv->emf_number_clients); ?>" placeholder="Number clients">
              ...
              <div class="form-group">
                <center>
                  <div class="form-check-inline">
                    ...
                    <input type="checkbox" name="po_finance" id="po_finance" class="form-check-input chk_lg" <?php echo e($indiv->po_finance); ?>>
...
unset($__errorArgs, $__bag); ?>
                  ...
                  <div class="form-check-inline">
                    ...
                    <input type="checkbox" name="in_finance" id="in_finance" class="form-check-input chk_lg" <?php echo e($indiv->in_finance); ?> >
