...
unset($__errorArgs, $__bag); ?>" value="<?php echo e($user->email); ?>" placeholder="">
...
unset($__errorArgs, $__bag); ?>" value="<?php echo e($business->ruc_tax); ?>" placeholder="">
        ...
        <div class="row">
          <div class="col-xs-12 col-sm-4 col-md-4">
            <div class="form-group">
              ...
              <!--<input type="text" name="date_company" id="date_company" class="form-control <?php $__errorArgs = ['date_company'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>" value="<?php echo e($business->date_company); ?>" placeholder="">-->
              <input type="text" name="date_company" id="date_company" class="form-control <?php $__errorArgs = ['date_company'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
...
unset($__errorArgs, $__bag); ?>" value="<?php echo e($business->contact_name); ?>" placeholder="">
...
unset($__errorArgs, $__bag); ?>" value="<?php echo e($business->president_name); ?>" placeholder="">
...
unset($__errorArgs, $__bag); ?>" value="<?php echo e($business->type_business); ?>" placeholder="">
...
unset($__errorArgs, $__bag); ?>" value="<?php echo e($business->phone); ?>" placeholder="">
...
unset($__errorArgs, $__bag); ?>" value="<?php echo e($business->country); ?>" placeholder="">
...
unset($__errorArgs, $__bag); ?>" value="<?php echo e($business->state); ?>" placeholder="">
...
unset($__errorArgs, $__bag); ?>" value="<?php echo e($business->city); ?>" placeholder="">
...
unset($__errorArgs, $__bag); ?>" value="<?php echo e($business->zip); ?>" placeholder="">
              <?php $__errorArgs = ['zip'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
...
unset($__errorArgs, $__bag); ?>" value="<?php echo e($business->address); ?>" placeholder="">
...
unset($__errorArgs, $__bag); ?>" value="<?php echo e($business->cell_phone); ?>" placeholder="">
...
unset($__errorArgs, $__bag); ?>" value="<?php echo e($business->website); ?>" placeholder="">
...
unset($__errorArgs, $__bag); ?>" value="<?php echo e($business->dba); ?>" placeholder="">
              <?php $__errorArgs = ['dba'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
...
unset($__errorArgs, $__bag); ?>" value="<?php echo e($business->secretary_name); ?>" placeholder="">
